...
public class StartScreenActivity extends AppCompatActivity {
    ...
    private void updateLoc() {
        ...
        if(locator.isLocationEnabled() || Locator.oldLocationExists(this)) {
            //wait for location
            locator.updateGPS(location -> {
                ...
                String city = locator.getCity();
                Log.d("TAG", "onSuccess: " + latitude + " " + longitude + " " + city);
                LocationObj locObj = new LocationObj(latitude, longitude, city, locator.prevLocationLoaded());
    ...
    private void getPermission() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            if((android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) && times == 2){
                displayManualPermit();
            }
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, PERMISSION_FINE_LOCATION);
