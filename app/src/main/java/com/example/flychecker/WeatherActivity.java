...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.hasExtra("weather")) {
            ...
            temperatureIv.setColorFilter(ContextCompat.getColor(this,Helpers.statusToColor(wd.checkTemperature())));
            ...
            humidityIv.setColorFilter(ContextCompat.getColor(this,Helpers.statusToColor(wd.checkHumidity())));
            ...
            precipitationIv.setColorFilter(ContextCompat.getColor(this,Helpers.statusToColor(wd.checkPrecipitation())));
            ...
            windIv.setColorFilter(ContextCompat.getColor(this,Helpers.statusToColor(wd.checkAllWindSpeeds())));
            ...
            dynamicHide(windSummaryTv,wd.getWindSpeedsSummary());
            ...
            gustsIv.setColorFilter(ContextCompat.getColor(this,Helpers.statusToColor(wd.checkGust())));
            ...
            cloudcoverIv.setColorFilter(ContextCompat.getColor(this,Helpers.statusToColor(wd.checkCloudCover())));
